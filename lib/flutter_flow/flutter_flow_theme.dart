...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7B61FF);
  late Color secondary = const Color(0xFF1A1A2E);
  late Color tertiary = const Color(0xFF202040);
  late Color alternate = const Color(0xFFB0B0C0);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFA0A0B0);
  late Color primaryBackground = const Color(0xFF072C3B);
  late Color secondaryBackground = const Color(0xFF1B1B2D);
  late Color accent1 = const Color(0xFF3838FF);
  late Color accent2 = const Color(0xFF1F1F3A);
  late Color accent3 = const Color(0xFF4D4D66);
  late Color accent4 = const Color(0xFF2E2E4D);
  late Color success = const Color(0xFF2DD4BF);
  late Color warning = const Color(0xFFFBBF24);
  late Color error = const Color(0xFFFF4C61);
